...
```
looks like there might be around 350 and 700

# look at total collected outliers
```{r}
mosquito |>
...
ggplot(mosquito, aes(total_collected)) +
  ...
  theme_bw()
```
looks like there are a good amount of outliers which make this boxplot look weird. im going to calculate the IQR to find the outlier limit
